...
namespace Tests.UnitTests
{
    ...
    public class AppConfigDefaultsTests
    {
        ...
        {
            AnalyticsConfig.AppSettings.Set(CopilotAdoptionDigestRecipients, string.Empty);
            AnalyticsConfig.AppSettings.Set(CopilotAdoptionDigestSenderUserId, string.Empty);
            AnalyticsConfig.AppSettings.Set(CopilotAdoptionDigestIntervalHours, string.Empty);
        ...
        {
            AnalyticsConfig.AppSettings.Set(CopilotAdoptionDigestRecipients, " execs@contoso.example; finance@contoso.example,EXECS@contoso.example ");
            AnalyticsConfig.AppSettings.Set(CopilotAdoptionDigestSenderUserId, " digest-sender@contoso.example ");
            AnalyticsConfig.AppSettings.Set(CopilotAdoptionDigestIntervalHours, "168");
