    ...
    public class PowerPlatformAdminActivityRecordParseTests
    {
        ...
        private const string LaunchPowerAppSampleJson = @"{
            ""PropertyCollection"": [
                ...
                { ""Name"": ""powerplatform.analytics.resource.tenant.id"", ""Value"": ""3aa5b2bd-6dca-4f72-a852-e1266fef6ed7"" },
                { ""Name"": ""enduser.principal_name"", ""Value"": ""AmberR@M365CPI84529596.OnMicrosoft.com"" },
                { ""Name"": ""enduser.role"", ""Value"": ""Admin"" }
            ],
            ""EnvironmentId"": ""aa289efd-09f4-eaeb-bbb8-c08fc9e27d09"",
            ""UserId"": ""AmberR@M365CPI84529596.OnMicrosoft.com"",
            ""ClientIP"": ""167.220.196.178"",
            ""Id"": ""e2a84675-8952-4d91-a2ea-4d89f310f1a7"",
            ""RecordType"": 256,
            ""CreationTime"": ""2026-05-19T13:17:34"",
            ""Operation"": ""LaunchPowerApp"",
            ""OrganizationId"": ""3aa5b2bd-6dca-4f72-a852-e1266fef6ed7"",
            ""UserType"": 2,
        ...
        public void LaunchPowerApp_Maps_To_PowerAppsAuditLogContent()
        {
            ...
            Assert.AreEqual("AmberR@M365CPI84529596.OnMicrosoft.com", apps.UserId);
        }
        ...
        private const string SharePowerAppBestEffortSampleJson = @"{
            ""PropertyCollection"": [
                ...
                { ""Name"": ""powerplatform.analytics.resource.principal.name"", ""Value"": ""BobS@M365CPI84529596.OnMicrosoft.com"" },
        ...
        public void SharePowerApp_Maps_With_SingleRecipient()
        {
            ...
            Assert.AreEqual("BobS@M365CPI84529596.OnMicrosoft.com", apps.Permissions[0].PrincipalName);
