...
namespace Common.Entities.CopilotAdoption
{
    ...
    public static class CopilotAdoptionPseudonymiser
    {
            ...
            LicensedUserAdoptionRow r, CopilotAdoptionGovernanceSettings settings)
        {
            ...
            var surrogate = Surrogate(r.UserId, r.UserPrincipalName, settings);

            return new LicensedUserAdoptionRow
            {
                UserId = r.UserId,
                UserPrincipalName = surrogate,
                Mail = null,
                ...
                SeatLicences = r.SeatLicences,
                Interactions = r.Interactions,
                ActiveDays = r.ActiveDays,
                ExpectedActiveDays = r.ExpectedActiveDays,
                AppsUsed = r.AppsUsed,
                AgentsUsed = r.AgentsUsed,
                CoworkInteractions = r.CoworkInteractions,
                UsedCowork = r.UsedCowork,
                FirstInteractionUtc = r.FirstInteractionUtc,
                LastInteractionUtc = r.LastInteractionUtc,
                DaysSinceLastUse = r.DaysSinceLastUse,
                ReportPrompts = r.ReportPrompts,
                ReportActiveDays = r.ReportActiveDays,
                ReportLastActivityUtc = r.ReportLastActivityUtc,
                ...
                RecommendedActionCode = r.RecommendedActionCode,
            ...
            LicenceOpportunityRow r, CopilotAdoptionGovernanceSettings settings)
        {
            ...
            return new LicenceOpportunityRow
            {
                ...
                CompanyName = null,
                ManagerUserPrincipalName = null,
                UnlicensedCopilotInteractions = r.UnlicensedCopilotInteractions,
                UnlicensedCopilotActiveDays = r.UnlicensedCopilotActiveDays,
                LastCopilotInteractionUtc = r.LastCopilotInteractionUtc,
                TeamsMessages = r.TeamsMessages,
                TeamsMeetings = r.TeamsMeetings,
                EmailsSent = r.EmailsSent,
                EmailsRead = r.EmailsRead,
                FilesViewedOrEdited = r.FilesViewedOrEdited,
                LastM365ActivityUtc = r.LastM365ActivityUtc,
                OpportunityScore = r.OpportunityScore,
                CopilotDemandScore = r.CopilotDemandScore,
