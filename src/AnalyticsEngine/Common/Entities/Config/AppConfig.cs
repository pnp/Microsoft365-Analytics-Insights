...
namespace Common.Entities.Config
{
    ...
    public class AppConfig
    {
        public AppConfig()
        {
            ...
            this.CopilotAdoptionDigestRecipients = ParseDelimitedList(ConfigurationManager.AppSettings.Get("CopilotAdoptionDigestRecipients"));
            this.CopilotAdoptionDigestSenderUserId = (ConfigurationManager.AppSettings.Get("CopilotAdoptionDigestSenderUserId") ?? string.Empty).Trim();
            this.CopilotAdoptionDigestIntervalHours = int.TryParse(ConfigurationManager.AppSettings.Get("CopilotAdoptionDigestIntervalHours"), out var digestIntervalHours)
