...
const licenceActivity: Record<keyof typeof en, string> = {
  ...
  'licenceActivity.coverageMessage.m365.disabled': 'La importación del informe de uso de Microsoft 365 está desactivada, por lo que no se puede medir nada para este servicio. Eso no significa que nadie lo use.',
