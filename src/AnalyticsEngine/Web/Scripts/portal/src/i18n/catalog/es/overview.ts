...
const overview: Record<keyof typeof en, string> = {
  ...
  'overview.enabledImport.activityLog': 'Actividad/auditoría',
  'overview.enabledImport.copilot': 'Copilot',
  'overview.enabledImport.copilotInteractionHistory': 'Historial de interacciones de IA de Copilot (en todo el inquilino salvo que esté limitado)',
  'overview.enabledImport.powerPlatform': 'Power Platform',
  'overview.enabledImport.dlpPolicyEvents': 'Eventos de directiva DLP',
  ...
  'overview.enabledImport.teamsCalls': 'Llamadas de Teams',
  'overview.enabledImport.copilotStudioCredits': 'Créditos de Copilot Studio (facturados)',
  'overview.enabledImport.azureCosts': 'Costes de Azure (Cost Management)',
