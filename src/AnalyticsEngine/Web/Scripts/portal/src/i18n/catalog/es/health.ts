...
const health: Record<keyof typeof en, string> = {
  ...
  'health.reason.componentUnhealthy': 'El componente {component} está en estado erróneo: {detail}',
  'health.reason.componentDegraded': 'El componente {component} está degradado: {detail}',
  ...
  'health.duration.hours': '{count} horas',
  'health.duration.minute': '{count} minuto',
  'health.duration.minutes': '{count} minutos',
  'health.duration.second': '{count} segundo',
  'health.duration.seconds': '{count} segundos',
