...
namespace Web.AnalyticsWeb.Controllers
{
    ...
    public class WebActivityAPIController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("overview")]
        public Task<IActionResult> Overview(int days = WebActivityQuery.DefaultWindowDays)
        {
        ...
        [HttpGet]
        [Route("journeys")]
        public Task<IActionResult> Journeys(
            int days = WebActivityQuery.DefaultWindowDays,
            int top = WebActivityQuery.DefaultTop)
        {
            var query = BuildQuery(days, top);
        ...
        [HttpGet]
        [Route("geography")]
        public Task<IActionResult> Geography(
            int days = WebActivityQuery.DefaultWindowDays,
            int top = WebActivityQuery.DefaultTop)
        {
            var query = BuildQuery(days, top);
        ...
        [HttpGet]
        [Route("technology")]
        public Task<IActionResult> Technology(
            int days = WebActivityQuery.DefaultWindowDays,
            int top = WebActivityQuery.DefaultTop)
        {
            var query = BuildQuery(days, top);
